                            ...
                            <div className="ms-3 relative">
                                <Dropdown>
                                    ...
                                    <Dropdown.Content>
                                        ...
                                        {user.admin === 1 && <Dropdown.Link href={route('admin.events')}>Event admin panel</Dropdown.Link> }
                ...
                <div className={(showingNavigationDropdown ? 'block' : 'hidden') + ' sm:hidden'}>
                    ...
                    <div className="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
                        ...
                        <div className="mt-3 space-y-1">
                            ...
                            {user.admin === 1 && <ResponsiveNavLink href={route('admin.events')}>Event admin panel</ResponsiveNavLink>}
